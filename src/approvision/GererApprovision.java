...
public class GererApprovision implements Initializable {
    ...
    public void remplir_list() throws SQLException {
        ...
        if (dateD.getValue() == null & dateF.getValue() == null) {
            try {
                PreparedStatement create = Menu.con.prepareStatement("select article.n_article,libelle,approvisiont.date,detail_app.qte_a,approvisiont.n_fournisseur, approvisiont.n_bon_a " +
    ...
    public void supprimer_Appro () throws IOException,SQLException {
        ...
        if(result.get() == ButtonType.OK) {
            ...
            PreparedStatement create = Menu.con.prepareStatement("delete from detail_app where (n_bon_a = ? and n_article = ?)");
    ...
    public String chercherDate(String n_bon_a) throws SQLException {
        String temp = null;
        PreparedStatement create = Menu.con.prepareStatement("select date from approvisiont where n_bon_a = ?");
