...
public class GererBonApp implements Initializable {
    ...
    public void remplir_list() throws SQLException {
        ...
        table.getItems().removeAll(table.getItems());
            ...
            try {
                PreparedStatement create = Menu.con.prepareStatement("select * from approvisiont");
    ...
    public void retourner(javafx.event.ActionEvent event) throws IOException, SQLException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("gererApprovision.fxml"));
    ...
    public void supprimer_Bon () throws IOException,SQLException {
        ...
        if(result.get() == ButtonType.OK) {
            ...
            PreparedStatement create = Menu.con.prepareStatement("select n_article,qte_a from detail_app where n_bon_a = ?");
            ...
            create = Menu.con.prepareStatement("delete from approvisiont where n_bon_a = ?");
            create.setString(1, selectedItem.getN_bon());
