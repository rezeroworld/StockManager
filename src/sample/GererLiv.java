...
public class GererLiv implements Initializable {
    ...
    public void remplir_list() throws SQLException {
        ...
        if (dateD.getValue() == null & dateF.getValue() == null) {
            try {
                PreparedStatement create = Main.con.prepareStatement("select article.n_article,libelle,livraison.date,detail_liv.qte_l,livraison.n_client, livraison.n_bon_l " +
    ...
    public void supprimer_liv () throws IOException,SQLException {
        ...
        if(result.get() == ButtonType.OK) {
            ...
            PreparedStatement create = Main.con.prepareStatement("delete from detail_liv where (n_bon_l = ? and n_article = ?)");
