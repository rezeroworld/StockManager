...
public class Sample7 implements Initializable {
    ...
    public void remplir_list() throws SQLException {
        ...
        if (dateD.getValue() == null & dateF.getValue() == null) {
            try {
                PreparedStatement create = Main.con.prepareStatement("select * from stock");
            ...
            try {
                PreparedStatement create = Main.con.prepareStatement("select * from stock where date >= ?");
            ...
            try {
                PreparedStatement create = Main.con.prepareStatement("select * from stock where date between ? and ?");
                create.setString(1,dateD.getValue().toString());
