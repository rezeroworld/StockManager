...
public class Sample5 implements Initializable {
    ...
    public void remplir_list(){
        ...
        if (villes.getSelectionModel().getSelectedItem() == "Toutes les villes"){
            try{
                PreparedStatement create = Main.con.prepareStatement("select * from client");
            ...
            try{
                PreparedStatement create = Main.con.prepareStatement("select * from client where adresse = ?");
    ...
    public void supprimer_client() throws IOException, SQLException {
        ...
        if(result.get() == ButtonType.OK){
            ...
            PreparedStatement create = Main.con.prepareStatement("delete from client where n_client = ?");
