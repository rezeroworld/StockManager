...
public class AddQuery {
    ...
    public void creer_livraison() throws SQLException {
        try {
            PreparedStatement create = Main.con.prepareStatement("create table livraison(n_bon_l char(10) not null, date date, n_client char(10) not null," +
    ...
    public void ajouter_article(String numArticle,String libelle, int prixUni, int stockMin) throws SQLException {
        try {
            ...
            PreparedStatement create = Main.con.prepareStatement("insert into article values(?,?,?,?)");
    ...
    public void ajouter_detailApp(String nbonA, String nArticle, int qteA)throws SQLException{
        ResultSet rs;
        String date = null;
        ...
        PreparedStatement create2 = Main.con.prepareStatement("select date from approvisiont where nbonA = ?");
