...
public class GererBonLiv implements Initializable{
    ...
    public void remplir_list() throws SQLException {
        ...
        try {
            PreparedStatement create = Main.con.prepareStatement("select * from livraison");
    ...
    public void supprimer_Bon () throws IOException,SQLException {
        ...
        if(result.get() == ButtonType.OK) {
            ...
            PreparedStatement create = Main.con.prepareStatement("delete from livraison where n_bon_l = ?");
